...
import {countActionIncrease, countAsyncActionIncrease} from '../../redux/actions';
const a = 124;
...
export default class Count extends Component {
    ...
    increaseOne = () => {
        ...
        // store.dispatch(countActionIncrease(1)); // action一般不手写，用方法生成；
        // 使用异步redux，注意使用中间件调用器和thunk来使用；
        store.dispatch(countAsyncActionIncrease(12));
    };
    render() {
